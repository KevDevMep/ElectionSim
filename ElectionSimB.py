...
trails.grid(row=5,column=3)
submit2 = tk.Button(root, text='Sim', command=simulator).grid(row=5,column=4)
submit3 = tk.Button(root, text='Stats', command=stats).grid(row=6,column=3)
submit6 = tk.Button(root, text='Export', command=export).grid(row=8,column=3)
...
# Filtering Section
title4 = tk.Label(root, text='Filters').grid(row=0, column=5)
check2 = tk.Checkbutton(root, variable=white, onvalue='White', offvalue='', text='White').grid(row=1, column=5)
check3 = tk.Checkbutton(root, variable=black, onvalue='Black', offvalue='',text='Black').grid(row=2, column=5)
check4 = tk.Checkbutton(root, variable=hispanic, onvalue='Hispanic', offvalue='', text='Hispanic').grid(row=3, column=5)
check5 = tk.Checkbutton(root, variable=asian, onvalue='Asian', offvalue='', text='Asian').grid(row=4, column=5)
check6 = tk.Checkbutton(root, variable=native, text='Native', onvalue='Native', offvalue='').grid(row=5, column=5)
check7 = tk.Checkbutton(root, variable=pacific, text='Pacific', onvalue='Pacific', offvalue='').grid(row=6, column=5)
check8 = tk.Checkbutton(root, variable=minority, text='Minority', onvalue='Minority', offvalue='').grid(row=7, column=5)
check9 = tk.Checkbutton(root, variable=dem, text='Dem', onvalue=True, offvalue=False).grid(row=8, column=5)
check10 = tk.Checkbutton(root, variable=rep, text='Rep', onvalue=True, offvalue=False).grid(row=9, column=5)
submit8 = tk.Button(root, text='Filter', command=filter).grid(row=10, column=5)

# Mapping Section
t1 = tk.Label(root, text='Mapping').grid(row=0, column=6)
r1 = tk.Radiobutton(root, text='Margin', variable=mapType, value='Margin').grid(row=1, column=6)
r2 = tk.Radiobutton(root, text='Minority', variable=mapType, value='MinorityPct').grid(row=2, column=6)
r3 = tk.Radiobutton(root, text='Dem', variable=mapType, value='DemPct').grid(row=3, column=6)
r4 = tk.Radiobutton(root, text='Rep', variable=mapType, value='RepPct').grid(row=4, column=6)
r5 = tk.Radiobutton(root, text='Swing', variable=mapType, value='Swing').grid(row=5, column=6)
submit = tk.Button(root, text='Map', command=map).grid(row=6, column=6)
